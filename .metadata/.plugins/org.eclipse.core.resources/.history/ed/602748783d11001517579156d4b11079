...
public class Mundo {
	...
	private Mundo(){
		...
		territoriosFronteira = new String[]{new String("SibÃ©ria"),new String("Calgary"),new String("Vancouver")};
		...
		territoriosFronteira = new String[]{new String("Alasca"),new String("Vancouver"),new String("QuÃ©bec")};
		...
		simb = Simbolo.CIRCULO;
		territoriosFronteira = new String[]{new String("Reino Unido"),new String("Calgary"),new String("QuÃ©bec")};
		...
		simb = Simbolo.TRIANGULO;
		territoriosFronteira = new String[]{new String("Alasca"),new String("Calgary'"),new String("QuÃ©bec"),new String("Texas"),new String("CalifÃ³rnia")};
		...
		simb = Simbolo.CIRCULO;
		territoriosFronteira = new String[]{new String("GroelÃ¢ndia"),new String("Vancouver"),new String("Texas"),new String("Nova York")};
		...
		territoriosFronteira = new String[]{new String("Vancouver"),new String("Texas"),new String("MÃ©xico")};
		...
		simb = Simbolo.TRIANGULO;
		territoriosFronteira = new String[]{new String("Vancouver"),new String("QuÃ©bec"),new String("Nova York"),new String("MÃ©xico"),new String("CalifÃ³rnia")};
		...
		simb = Simbolo.QUADRADO;
		territoriosFronteira = new String[]{new String("Texas"),new String("QuÃ©bec")};
		...
		simb = Simbolo.QUADRADO;
		territoriosFronteira = new String[]{new String("CalifÃ³rnia"), new String("Texas"),new String("Venezuela")};
		...
		simb = Simbolo.TRIANGULO;
		territoriosFronteira = new String[]{new String("MÃ©xico"),new String("Brasil"),new String("Peru")};
		territorios[1] = new Territorio(nomeT, poligono, 0, null, simb, territoriosFronteira);
		...
		simb = Simbolo.CIRCULO;
		territoriosFronteira = new String[]{new String("Venezuela"),new String("Peru"),new String("Argentina"), new String("NigÃ©ria")};
		territorios[2] = new Territorio(nomeT, poligono, 0, null, simb, territoriosFronteira);
		...
		simb = Simbolo.CIRCULO;
		territoriosFronteira = new String[]{new String("Espanha"),new String("ItÃ¡lia"),new String("Egito"),new String("NigÃ©ria")};
		territorios[0] = new Territorio(nomeT, poligono, 0, null, simb, territoriosFronteira);
		...
		simb = Simbolo.TRIANGULO;
		territoriosFronteira = new String[]{new String("ArgÃ©lia"),new String("RomÃªnia"),new String("JordÃ¢nia"),new String("SomÃ¡lia"),new String("NigÃ©ria")};
		territorios[1] = new Territorio(nomeT, poligono, 0, null, simb, territoriosFronteira);
		...
		simb = Simbolo.CIRCULO;
		territoriosFronteira = new String[]{new String("Brasil"), new String("ArgÃ©lia"), new String("Egito"), new String("SomÃ¡lia"), new String("Angola")};
		territorios[2] = new Territorio(nomeT, poligono, 0, null, simb, territoriosFronteira);
		...
		simb = Simbolo.QUADRADO;
		territoriosFronteira = new String[]{new String("ArÃ¡bia Saudita"), new String("Egito"), new String("NigÃ©ria"), new String("Angola"), new String("Ã�frica do Sul")};
		territorios[3] = new Territorio(nomeT, poligono, 0, null, simb, territoriosFronteira);
		...
		simb = Simbolo.QUADRADO;
		territoriosFronteira = new String[]{new String("NigÃ©ria"),new String("SomÃ¡lia"),new String("Ã�frica do Sul")};
		territorios[4] = new Territorio(nomeT, poligono, 0, null, simb, territoriosFronteira);


		nomeT = "Ã�frica do Sul";
		...
		simb = Simbolo.TRIANGULO;
		territoriosFronteira = new String[]{new String("Angola"),new String("SomÃ¡lia")};
		territorios[5] = new Territorio(nomeT, poligono, 0, null, simb, territoriosFronteira);
		...
		simb = Simbolo.CIRCULO;
		territoriosFronteira = new String[]{new String("GroelÃ¢ndia"), new String("FranÃ§a")};
		territorios[0] = new Territorio(nomeT, poligono, 0, null, simb, territoriosFronteira);
		...
		simb = Simbolo.QUADRADO;
		territoriosFronteira = new String[]{new String("FranÃ§a"),new String("ItÃ¡lia"), new String("LetÃ´nia"), new String("EstÃ´nia")};
		territorios[1] = new Territorio(nomeT, poligono, 0, null, simb, territoriosFronteira);
		...
		simb = Simbolo.TRIANGULO;
		territoriosFronteira = new String[]{new String("Reino Unido"), new String("SuÃ©cia"), new String("ItÃ¡lia"), new String("Espanha")};
		territorios[2] = new Territorio(nomeT, poligono, 0, null, simb, territoriosFronteira);
		...
		simb = Simbolo.QUADRADO;
		territoriosFronteira = new String[]{new String("FranÃ§a"), new String("SuÃ©cia"), new String("PolÃ´nia"), new String("RomÃªnia"), new String("ArgÃ©lia")};
		territorios[3] = new Territorio(nomeT, poligono, 0, null, simb, territoriosFronteira);
		...
		simb = Simbolo.TRIANGULO;
		territoriosFronteira = new String[]{new String("ItÃ¡lia"), new String("LetÃ´nia"), new String("UcrÃ¢nia"), new String("RomÃªnia")};
		territorios[4] = new Territorio(nomeT, poligono, 0, null, simb, territoriosFronteira);
		...
		simb = Simbolo.TRIANGULO;
		territoriosFronteira = new String[]{new String("ItÃ¡lia"), new String("PolÃ´nia"), new String("UcrÃ¢nia"), new String("Egito")};
		territorios[5] = new Territorio(nomeT, poligono, 0, null, simb, territoriosFronteira);
		...
		simb = Simbolo.CIRCULO;
		territoriosFronteira = new String[]{new String("PolÃ´nia"), new String("RomÃªnia"), new String("LetÃ´nia"), new String("Turquia")};
		territorios[6] = new Territorio(nomeT, poligono, 0, null, simb, territoriosFronteira);
		...
		simb = Simbolo.CIRCULO;
		territoriosFronteira = new String[]{new String("FranÃ§a"), new String("ArgÃ©lia")};
		territorios[7] = new Territorio(nomeT, poligono, 0, null, simb, territoriosFronteira);
		...
		simb = Simbolo.CIRCULO;
		territoriosFronteira = new String[]{new String("SuÃ©cia"), new String("LetÃ´nia"), new String("RÃºssia")};
		territorios[0] = new Territorio(nomeT, poligono, 0, null, simb, territoriosFronteira);
		...
		simb = Simbolo.TRIANGULO;
		territoriosFronteira = new String[]{new String("EstÃ´nia"), new String("LetÃ´nia"), new String("CazaquistÃ£o"), new String("SibÃ©ria")};
		territorios[1] = new Territorio(nomeT, poligono, 0, null, simb, territoriosFronteira);
		...
		simb = Simbolo.QUADRADO;
		territoriosFronteira = new String[]{new String("RÃºssia"), new String("CazaquistÃ£o"), new String("Alasca")};
		territorios[2] = new Territorio(nomeT, poligono, 0, null, simb, territoriosFronteira);
		...
		simb = Simbolo.QUADRADO;
		territoriosFronteira = new String[]{new String("PolÃ´nia"), new String("UcrÃ¢nia"), new String("SuÃ©cia"), new String("EstÃ´nia"), new String("Turquia"), new String("CazaquistÃ£o"), new String("RÃºssia")};
		territorios[3] = new Territorio(nomeT, poligono, 0, null, simb, territoriosFronteira);
		...
		simb = Simbolo.CIRCULO;
		territoriosFronteira = new String[]{new String("SibÃ©ria"), new String("RÃºssia"), new String("LetÃ´nia"), new String("Turquia"), new String("China"), new String("MongÃ³lia"), new String("JapÃ£o")};
		territorios[4] = new Territorio(nomeT, poligono, 0, null, simb, territoriosFronteira);
		...
		simb = Simbolo.TRIANGULO;
		territoriosFronteira = new String[]{new String("UcrÃ¢nia"), new String("LetÃ´nia"), new String("CazaquistÃ£o"), new String("China"), new String("PaquistÃ£o"), new String("SÃ­ria")};
		territorios[5] = new Territorio(nomeT, poligono, 0, null, simb, territoriosFronteira);
		...
		simb = Simbolo.TRIANGULO;
		territoriosFronteira = new String[]{new String("CazaquistÃ£o"), new String("China"), new String("JapÃ£o")};
		territorios[6] = new Territorio(nomeT, poligono, 0, null, simb, territoriosFronteira);
		...
		simb = Simbolo.QUADRADO;
		territoriosFronteira = new String[]{new String("MongÃ³lia"), new String("CorÃ©ia do Norte"), new String("CorÃ©ia do Sul"), new String("CazaquistÃ£o"), new String("Ã�ndia"), new String("PaquistÃ£o"),new String("Turquia")};
		territorios[7] = new Territorio(nomeT, poligono, 0, null, simb, territoriosFronteira);
		...
		simb = Simbolo.QUADRADO;
		territoriosFronteira = new String[]{new String("Turquia"), new String("PaquistÃ£o"), new String("IrÃ£"), new String("Iraque"), new String("JordÃ¢nia")};
		territorios[8] = new Territorio(nomeT, poligono, 0, null, simb, territoriosFronteira);
		...
		simb = Simbolo.CIRCULO;
		territoriosFronteira = new String[]{new String("SÃ­ria"), new String("Turquia"), new String("China"), new String("IrÃ£"),new String("Ã�ndia")};
		...
		simb = Simbolo.QUADRADO;
		territoriosFronteira = new String[]{new String("PaquistÃ£o"), new String("SÃ­ria"), new String("Iraque")};
		...
		simb = Simbolo.QUADRADO;
		territoriosFronteira = new String[]{new String("Egito"), new String("ArÃ¡bia Saudita"), new String("Iraque"), new String("SÃ­ria")};
		...
		simb = Simbolo.TRIANGULO;
		territoriosFronteira = new String[]{new String("ArÃ¡bia Saudita"), new String("JordÃ¢nia"), new String("SÃ­ria"), new String("IrÃ£")};
		territorios[12] = new Territorio(nomeT, poligono, 0, null, simb, territoriosFronteira);

		nomeT = "ArÃ¡bia Saudita";
		...
		simb = Simbolo.CIRCULO;
		territoriosFronteira = new String[]{new String("SomÃ¡lia"), new String("JordÃ¢nia"), new String("Iraque")};
		...
		simb = Simbolo.TRIANGULO;
		territoriosFronteira = new String[]{new String("IndonÃ©sia"), new String("PaquistÃ£o"), new String("China"), new String("CorÃ©ia do Sul"), new String("Bangladesh")};
		territorios[14] = new Territorio(nomeT, poligono, 0, null, simb, territoriosFronteira);

		nomeT = "CorÃ©ia do Norte";
		...
		simb = Simbolo.QUADRADO;
		territoriosFronteira = new String[]{new String("JapÃ£o"), new String("China"), new String("CorÃ©ia do Sul")};
		territorios[15] = new Territorio(nomeT, poligono, 0, null, simb, territoriosFronteira);

		nomeT = "CorÃ©ia do Sul";
		...
		simb = Simbolo.TRIANGULO;
		territoriosFronteira = new String[]{new String("CorÃ©ia do Norte"), new String("China"), new String("Ã�ndia"), new String("Bangladesh"), new String("TailÃ¢ndia")};
		...
		simb = Simbolo.CIRCULO;
		territoriosFronteira = new String[]{new String("CazaquistÃ£o"), new String("MongÃ³lia"), new String("CorÃ©ia do Norte")};
		...
		simb = Simbolo.CIRCULO;
		territoriosFronteira = new String[]{new String("Ã�ndia"), new String("CorÃ©ia do Sul"), new String("TailÃ¢ndia"), new String("IndonÃ©sia")};
		...
		simb = Simbolo.TRIANGULO;
		territoriosFronteira = new String[]{new String("CorÃ©ia do Sul"), new String("Bangladesh")};
		...
		simb = Simbolo.TRIANGULO;
		territoriosFronteira = new String[]{new String("Ã�ndia"), new String("Bangladesh"), new String("AustrÃ¡lia"), new String("Nova ZelÃ¢ndia")};
		territorios[0] = new Territorio(nomeT, poligono, 0, null, simb, territoriosFronteira);
		...
		simb = Simbolo.CIRCULO;
		territoriosFronteira = new String[]{new String("AustrÃ¡lia")};
		territorios[1] = new Territorio(nomeT, poligono, 0, null, simb, territoriosFronteira);
		...
		simb = Simbolo.TRIANGULO;
		territoriosFronteira = new String[]{new String("IndonÃ©sia"), new String("Nova ZelÃ¢ndia")};
		territorios[2] = new Territorio(nomeT, poligono, 0, null, simb, territoriosFronteira);

		nomeT = "Nova ZelÃ¢ndia";
		...
		simb = Simbolo.QUADRADO;
		territoriosFronteira = new String[]{new String("AustrÃ¡lia"), new String("IndonÃ©sia")};
		territorios[3] = new Territorio(nomeT, poligono, 0, null, simb, territoriosFronteira);
